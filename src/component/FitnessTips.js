...
const FitnessTips = () => {
  return (
    <ThemeProvider theme={theme}>
      <BackgroundBox>
        <Typography
          sx={{ fontSize: '80px', textAlign: 'center', mb: 3 }}
          component="span"
        >
          <ReactTyped
...
const BackgroundBox = styled(Box)`
  min-height: 100vh;
  padding: 3rem;
  background-image: url('https://img.freepik.com/free-photo/woman-mat-doing-abdominal-exercise_23-2148435328.jpg?t=st=1722144053~exp=1722147653~hmac=16ba4655acc3e94bf9c65309207e6da67aff300fffdc89f14b2791ce29b26970&w=740');
